...
class EcoSpold(etree.ElementBase):
    ...
    validationId = DataHelper.create_attribute("validationId", int)
    """int:"""

    validationStatus = DataHelper.create_attribute("validationStatus", str)
    """str:"""
...
class Dataset(etree.ElementBase):
    ...
    internalSchemaVersion = DataHelper.create_attribute("internalSchemaVersion", str)

    generator = DataHelper.create_attribute("generator", str)
    """str: The person or organisation that collected, compiled or published the
    original data."""

    timestamp = DataHelper.create_attribute("timestamp", datetime)
    """datetime: Automatically generated date when dataset is created"""

    validCompanyCodes = DataHelper.create_attribute("validCompanyCodes", str)
    """str: XML file for valid company codes."""

    validRegionalCodes = DataHelper.create_attribute("validRegionalCodes", str)
    """str: XML file for valid regional codes."""

    validCategories = DataHelper.create_attribute("validCategories", str)
    """str: XML file for valid categories."""

    validUnits = DataHelper.create_attribute("validUnits", str)
...
class Exchange(etree.ElementBase):
    ...
    category = DataHelper.create_attribute("category", str)
    ...
    subCategory = DataHelper.create_attribute("subCategory", str)
    """str: Describes the subCategory one particular exchange belongs to
    (in English language). Category and subCategory are required for
    elementary flows because they have a discriminative function."""

    localCategory = DataHelper.create_attribute("localCategory", str)
    """str: Describes the category one particular exchange belongs to
    (in German local language).See further explanations in 'category'.
    """

    localSubCategory = DataHelper.create_attribute("localSubCategory", str)
    """str: Describes the subCategory one particular exchange belongs to
    (in German local language).See further explanations in
    'subCategory'."""

    CASNumber = DataHelper.create_attribute("CASNumber", str)
    ...
    name = DataHelper.create_attribute("name", str)
    ...
    location = DataHelper.create_attribute("location", str)
    ...
    unit = DataHelper.create_attribute("unit", str)
    ...
    meanValue = DataHelper.create_attribute("meanValue", float)
    ...
    uncertaintyType = DataHelper.create_attribute("uncertaintyType", int)
    ...
    standardDeviation95 = DataHelper.create_attribute("standardDeviation95", float)
    ...
    referenceToSource = DataHelper.create_attribute("referenceToSource", int)
    ...
    pageNumbers = DataHelper.create_attribute("pageNumbers", str)
    ...
    generalComment = DataHelper.create_attribute("generalComment", str)
    ...
    localName = DataHelper.create_attribute("localName", str)
    ...
    infrastructureProcess = DataHelper.create_attribute("infrastructureProcess", bool)
    ...
    minValue = DataHelper.create_attribute("minValue", float)
    ...
    maxValue = DataHelper.create_attribute("maxValue", float)
    ...
    mostLikelyValue = DataHelper.create_attribute("mostLikelyValue", float)
...
class Allocation(etree.ElementBase):
    ...
    allocationMethod = DataHelper.create_attribute("allocationMethod", int)
    ...
    fraction = DataHelper.create_attribute("fraction", float)
    ...
    explanations = DataHelper.create_attribute("explanations", str)
...
class ReferenceFunction(etree.ElementBase):
    ...
    amount = DataHelper.create_attribute("amount", float)
    ...
    includedProcesses = DataHelper.create_attribute("includedProcesses", str)
    ...
    infrastructureIncluded = DataHelper.create_attribute("infrastructureIncluded", bool)
    ...
    statisticalClassification = DataHelper.create_attribute(
...
class Geography(etree.ElementBase):
    ...
    text = DataHelper.create_attribute("text", str)
...
class DataSetInformation(etree.ElementBase):
    ...
    impactAssessmentResult = DataHelper.create_attribute("impactAssessmentResult", bool)
    ...
    version = DataHelper.create_attribute("version", float)
    ...
    internalVersion = DataHelper.create_attribute("internalVersion", float)
    ...
    energyValues = DataHelper.create_attribute("energyValues", int)
    ...
    languageCode = DataHelper.create_attribute("languageCode", str)
    """str: 2 letter ISO language codes are used. Default language is English.
    Lower case letters are used."""

    localLanguageCode = DataHelper.create_attribute("localLanguageCode", str)
...
class TimePeriod(etree.ElementBase):
    ...
    dataValidForEntirePeriod = DataHelper.create_attribute(
...
class Representativeness(etree.ElementBase):
    ...
    percent = DataHelper.create_attribute("percent", float)
    ...
    productionVolume = DataHelper.create_attribute("productionVolume", str)
    ...
    samplingProcedure = DataHelper.create_attribute("samplingProcedure", str)
    ...
    extrapolations = DataHelper.create_attribute("extrapolations", str)
    ...
    uncertaintyAdjustments = DataHelper.create_attribute("uncertaintyAdjustments", str)
...
class Source(etree.ElementBase):
    ...
    sourceType = DataHelper.create_attribute("sourceType", int)
    ...
    firstAuthor = DataHelper.create_attribute("firstAuthor", str)
    ...
    additionalAuthors = DataHelper.create_attribute("additionalAuthors", str)
    ...
    year = DataHelper.create_attribute("year", int)
    ...
    title = DataHelper.create_attribute("title", str)
    ...
    nameOfEditors = DataHelper.create_attribute("nameOfEditors", str)
    """str: Contains the names of the editors (if any)."""

    titleOfAnthology = DataHelper.create_attribute("titleOfAnthology", str)
    ...
    placeOfPublications = DataHelper.create_attribute("placeOfPublications", str)
    ...
    publisher = DataHelper.create_attribute("publisher", str)
    ...
    journal = DataHelper.create_attribute("journal", str)
    """str: Indicates the name of the journal an article is published in."""

    volumeNo = DataHelper.create_attribute("volumeNo", int)
    """int: Indicates the volume of the journal an article is published in."""

    issueNo = DataHelper.create_attribute("issueNo", str)
...
class Validation(etree.ElementBase):
    ...
    proofReadingDetails = DataHelper.create_attribute("proofReadingDetails", str)
    ...
    proofReadingValidator = DataHelper.create_attribute("proofReadingValidator", int)
    ...
    otherDetails = DataHelper.create_attribute("otherDetails", str)
...
class DataEntryBy(etree.ElementBase):
    ...
    qualityNetwork = DataHelper.create_attribute("qualityNetwork", int)
...
class DataGeneratorAndPublication(etree.ElementBase):
    ...
    dataPublishedIn = DataHelper.create_attribute("dataPublishedIn", int)
    ...
    referenceToPublishedSource = DataHelper.create_attribute(
    ...
    copyright = DataHelper.create_attribute("copyright", bool)
    """bool: Indicates whether or not a copyright exists. '1' (Yes) or '0' (No)
    should be entered correspondingly."""

    accessRestrictedTo = DataHelper.create_attribute("accessRestrictedTo", int)
    ...
    companyCode = DataHelper.create_attribute("companyCode", str)
    ...
    countryCode = DataHelper.create_attribute("countryCode", str)
...
class Person(etree.ElementBase):
    ...
    address = DataHelper.create_attribute("address", str)
    ...
    telephone = DataHelper.create_attribute("telephone", str)
    """str: Phone number including country and regional codes."""

    telefax = DataHelper.create_attribute("telefax", str)
    """str: Fax number including country and regional codes."""

    email = DataHelper.create_attribute("email", str)
